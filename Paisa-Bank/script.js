// import and confi...
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyA3K5q2ouGE-MjoHq5AibmrrzqqyWbGUcY",
    authDomain: "aapsra-bank.firebaseapp.com",
    projectId: "aapsra-bank",
    storageBucket: "aapsra-bank.appspot.com",
    messagingSenderId: "721574073405",
    appId: "1:721574073405:web:7d3f56223d6f8439c0c654"
  };
...
window.onload = function () {
    ...
    function loginValidation() {
        ...
        if (lAccNo.match(accNoPat) && lAccPin.match(accPinPat)) {
            ...
            // document.getElementById('errMsg').innerHTML = "Enter valid details"
    ...
    function registerValidation() {
        ...
        
        {
            ...
            set(ref(db, "accNo " + rAccNo + "/received"), {
                ...
                console.log("received amt update");
            }).catch((error) => {
...
function depoist(){
  ...
  document.getElementById('dep-submit').addEventListener('click',function(){
    ...
    if(depoistAmt>=100){
      ...
      alert('Minimum depoist amount Rs.100');
    }
  });
}
